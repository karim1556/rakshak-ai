...
function DispatchContent() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/20 text-slate-900 flex flex-col">
      {/* Dispatch Modal */}
      ...
      <header className="h-14 border-b border-slate-200/60 flex items-center justify-between px-5 flex-shrink-0 bg-white/70 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-3 text-xs">
          {criticalCount > 0 && (
            <span className="flex items-center gap-1 text-red-600 bg-red-50 px-2.5 py-1.5 rounded-full border border-red-200 animate-pulse font-semibold">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Session List */}
        <div className="w-72 border-r border-slate-200/60 flex flex-col flex-shrink-0 bg-white/50">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {selected ? (
            <>
              {/* Session Header */}
              <div className="px-5 py-3.5 border-b border-slate-200/60 flex items-center justify-between flex-shrink-0 bg-white/60 backdrop-blur-sm">
                <div>
              ...
              <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-64 flex flex-col flex-shrink-0 bg-white/50">

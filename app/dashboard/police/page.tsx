    ...
    <div className="h-screen bg-zinc-950 text-white flex flex-col">
      ...
      <header className="h-12 border-b border-zinc-800/50 flex items-center justify-between px-4 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium">Police Command</span>
        </div>
            ...
            {loading ? (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-medium truncate flex-1">{inc.summary || 'Incident'}</span>
                </div>
            ...
            {selected ? (
              <div className="space-y-3 max-w-xl">
                <div className="flex items-start justify-between">
                  <div>
                    <h2 className="text-sm font-semibold">{selected.summary || 'Incident'}</h2>
                    <div className="flex gap-1 mt-1">
                      ...
                      <span className="text-[9px] px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-400">{selected.type}</span>
                    </div>
                  </div>
                  <div className="flex gap-1">
                    {selected.status === 'active' && (
                      <button onClick={() => handleAssign(selected.id)} className="text-[10px] px-2 py-1 bg-blue-500/10 text-blue-400 rounded hover:bg-blue-500/20 transition-colors">
                ...
                {selected.risks?.length > 0 && (
                  <div>
                    <p className="text-[10px] text-zinc-500 mb-1">Risks</p>

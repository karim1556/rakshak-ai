...
function FireContent() {
  ...
  const markers = [
    ...incidents.filter(i => i.location_lat && i.location_lng).map(i => ({
      ...
      popup: `<b>📍 ${i.summary || 'Fire Incident'}</b><br/><em style="color:#6366f1">Live Location</em>`,
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-1.5">
                    {selected.status === 'active' && (
                      <button onClick={() => handleAssign(selected.id)} className="text-[10px] px-3 py-1.5 bg-orange-50 text-orange-600 rounded-lg hover:bg-orange-100 transition-colors font-semibold border border-orange-200 shadow-sm">
